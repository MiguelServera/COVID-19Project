...
//Simple cass to advertise the user for the precautions of the COVID.
public class Precautions extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
